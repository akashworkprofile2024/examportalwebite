...
if (isset($_POST['submit'])) {
    ...
    $update_query = "UPDATE studentdetail SET 
        name = '$name', 
        lname = '$lname', 
        age = '$age', 
        phone = '$phone', 
    ...
    if ($con->query($update_query) === TRUE) {
        echo"<script>";
            echo "window.location.href='studentprofile.php'";
        echo"</script>";
            ...
            <nav id="sidebarMenu" class="col-sm-3 col-lg-2 d-sm-block bg-purple sidebar collapse show ">
                <div class="position-sticky pt-3">
                    ...
                    <li class="nav-item ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active disabled text-light mt-1" href="studentprofile.php">
                                <b class="">Profile Info</b>
                            </a>
                        </li>
                        <li class="nav-item sildeanimation">
                          ...
                          <style>
                            .form-control{
                                border: 3px solid #AA86E7;
                                      ...
                                      <form action="studentupdate_profile.php" method="post" class="text-dark">
                                         ...
                                         <!-- Student Department  -->
                                              ...
                                              <header><h5 class="mt-3 text-light">Course</h4></header>
                                                  <div class=form-floating>
                                                  <input type="tel" class="form-control" id="dept"  name="dept" value="<?php echo htmlspecialchars($user['dept'])?>" >
                                                  <label for="dept" class="form-label">Course Enrolled</label>
                                                  </div>     
