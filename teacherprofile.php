                                         ...
                                         <!-- Student Department  -->
                                          ...
                                          <header><h5 class="mt-3 text-light">Username</h4></header>
                                              ...
                                              <div class="d-flex justify-content-center">  
                                                <button class='btn btn-primary fw-bold text-center mb-2'><a style="text-decoration: none;" class="text-light" href="teacherupdate_profile.php">EDIT PROFILE</a></button>
                                              </div> 
                                      </form>
                </div>
