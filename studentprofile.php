            ...
            <nav id="sidebarMenu" class="col-sm-3 col-lg-2 d-sm-block bg-purple sidebar collapse show ">
                <div class="position-sticky pt-3">
                    ...
                    <li class="nav-item ">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link active disabled text-light mt-1" href="#">
                                <b>Profile Info</b>
                            </a>
                        </li>
                        <li class="nav-item sildeanimation">
                ...
                <div class="row">
                    <div  class="row custom-row  ">
                              ...
                              <img src="data:image/jpeg;base64,<?php echo base64_encode($user['image']);?>" alt="Rounded Image" class="rounded-image">
                                      ...
                                      <form action="stu_connect.php" method="post" class="text-dark">
                                         ...
                                         <!-- Student Department  -->
                                              ...
                                              <header><h5 class="mt-3 text-light">Enrolled Course</h4></header>
                                                  <div class=form-floating>
                                                  <input type="tel" class="form-control" id="dept"  name="dept" value="<?php echo htmlspecialchars($user['dept'])?>" readonly>
                                                  <label for="dept" class="form-label">Course Name</label>
                                                  </div>    
                      
                      
                                          <!-- Student Course fees  -->
                      
                                          <header><h5 class="mt-3 text-light">Course Fees</h4></header>
                                              <div class="form-floating">
                                                  <input  type="tel" class="form-control " id="fees" name="fees" value="<?php echo htmlspecialchars($user['fees'])?>" readonly>
                                          ...
                                          <header><h5 class="mt-3 text-light">Username</h4></header>
                                              ...
                                              <div class="d-flex justify-content-center">  
                                                <button class='btn btn-primary fw-bold text-center mb-2'><a style="text-decoration: none;" class="text-light" href="studentupdate_profile.php">EDIT PROFILE</a></button>
                                              </div> 
                                      </form>
                </div>
