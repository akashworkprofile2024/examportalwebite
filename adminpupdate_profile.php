...
if (isset($_POST['submit'])) {
    ...
    $update_query = "UPDATE admindetail SET 
        name = '$name', 
        lname = '$lname', 
        age = '$age', 
        phone = '$phone', 
        ...
        username = '$username', 
        pass = '$password' 
        WHERE id = {$_SESSION['user']['id']}"; // Assuming `id` is the primary key
                          ...
                          <style>
                            .form-control{
                                border: 3px solid #AA86E7;
                                      ...
                                      <form action="adminpupdate_profile.php" method="post" class="text-dark">
                                         ...
                                         <!-- Student Department  -->
                                              ...
                                              <header><h5 class="mt-3 text-light">Department</h4></header>
                                                  <div class=form-floating>
                                                  <input type="tel" class="form-control" id="dept"  name="dept" value="System Admin"  >
