    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-sm-9 ms-sm-auto col-lg-10 px-sm-4">
                ...
                <div class="h1 text-light text-center">Update Student Details</div>  
...
if (isset($_GET['student_id'])) {
    ...
    $sql = "SELECT * FROM studentdetail WHERE uid = $student_id";
...
if (isset($_POST['update'])) {
    ...
    // Update query
    $update_sql = "UPDATE studentdetail SET 
                    name = '$name',
                    lname = '$lname',
                    age = '$age',
                    phone = '$phone',
...
<div class="container mt-1 text-light">
    ...
    <form method="POST">
        ...
        <div class="mb-3 text-start">
            ...
            <input type="text" class="form-control" id="age" name="age" value="<?php echo $student['age']; ?>" required>
        </div>
        <div class="mb-3 text-start">
        ...
        <div class="mb-3 text-start">
            ...
            <input type="text" class="form-control" id="dept" name="dept" value="<?php echo $student['dept']; ?>" required>
        </div>
        <div class="mb-3 text-start">
        ...
        <div class="mb-3 text-start">
            ...
            <input type="password" class="form-control" id="password" name="password" value="<?php echo $student['pass']; ?>" required>
        </div>
        <button type="submit" class="btn btn-primary fw-bold" name="update">Update</button>
        &nbsp;&nbsp;
        <button type="submit" class="btn btn-danger fw-bold"><a class="text-light" style="text-decoration: none;" href="adminhandle_student.php">Close</a></button>
    </form>
</div>
